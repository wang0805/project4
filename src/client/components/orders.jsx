...
class Orders extends React.Component {
  ...
  componentWillMount() {
    // fetch('api/orders')
    //   .then((res) => res.json())
    //   .then((resultrows) => this.setState({data: resultrows}, () => console.log('result of fetch:', resultrows)));
    this.setState({
  ...
  render() {
    ...
    const result = this.props.result.filter((c) => c.orderstatus === 'active' && c.user_id != this.props.user); //use result instead of state
    return (
      <Paper className={classes.root}>
        ...
        <div className={classes.tableWrapper}>
          <Table className={classes.table} aria-labelledby="tableTitle">
            ...
            />
            <TableBody>
              {stableSort(result, getSorting(order, orderBy)) //somehow data to props doesnt happen twice so cant use data here
